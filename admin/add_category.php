...
<head>
    ...
    <!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="images/Migh.jpeg">
    <title>MIGH - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <!-- Logo icon -->
                        <b><img src="images/Migh.jpeg" alt="homepage" class="dark-logo" width = "75px"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><b></b></span>
                    </a>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                           <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/users/1.JPG" alt="user" class="profile-pic" /></a> 
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2022 All rights reserved. Made with &#x1F49C; by <b>FABAU</b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
